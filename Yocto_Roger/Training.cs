namespace Yocto_Roger
{
    public class Training
    {
        ...
        public static void SetUpWeights(ref double[,] weights) //рандомное заполнение двухмерного массива весов
        {
            if (Parameters.isDebug)
        ...
        public static void SetUpWeights(ref double [][,] weights) //рандомное заполнение массива двухмерных массивов весов (подойдет для средних слоев)
        {
            if (Parameters.isDebug)
                Console.Write($"weights[][,] = \n");
